				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="datacite_prefix">
							<option value="10.4225/">10.4225</option>
						</select>
					</div>
				</div>																			
				<div class="control-group">
...
<div class="modal hide fade" id="edit_trusted_client_modal">
	...
	<div class="modal-footer">
		<span id="result_msg"></span>
		<a id="add_confirm" href="javascript:;" class="btn btn-primary" data-loading-text="Updating...This might take several seconds">Update Trusted DOI Client</a>
		<a href="#" class="btn hide" data-dismiss="modal">Close</a>
	</div>
</div>
		...
		<table class="table table-bordered data-table">
			...
			{{#.}}
				<tr>
					...
					<a href="javascript:;" class="remove btn btn-small btn-danger" tip="Remove" ip="{{ip_address}}" app_id="{{app_id}}"><i class="icon-white icon-remove"></i></a>
					</td>
				</tr>
			{{/.}}
			</tbody>
